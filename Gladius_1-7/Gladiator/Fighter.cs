...
namespace Gladius
{
    ...
    public class Fighter
    {
        ...
        {
            int toHit = Roller.rollXSidedDice(20,1,1) + (Agility + (Strength / 2) + (Intelligence / 2) + Luck);
        ...
        public int Avoid()
        {
            int avoid = Roller.rollXSidedDice(20,1,1) + (Agility + (Constitution / 2) + (Intelligence / 2) + Luck);
        ...
        { 
           int inflict = ((Strength / 2) + (Roller.rollXSidedDice(12,1,1)));
