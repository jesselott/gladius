        ...
        public EnemyGladiator(int character, Fighter f)
        {
            switch (character)
            {
                case 1:
                    ...
                    specialMove = "Jody throws a tantrum.  Yes, this is Jody's special move";
                    break;
                case 2:
                    Name = "Macho Dan";
                    Strength = 15;
                ...
                case 4:
                    ...
                    specialMove = "Mr. Biscuits throws you down and sits on you, crushing the life out of you slowly, but surely.\nThe faint smell of twinkie, bacon and ass permeate your senses as you start to fade away.";
                    break;
                case 5:
                    Name = "Rich Ro$$";
                    Strength = 18;
