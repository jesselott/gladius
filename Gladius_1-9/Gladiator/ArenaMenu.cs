...
namespace Gladius
{
    public class ArenaMenu
    {
        ...
        string input;
        public ArenaMenu(ref Fighter f, int enemyPick) 
        {
        Console.Clear();
        Console.WriteLine("***Arena Menu***");
            ...
            ChooseOption(input.ToLower(), ref f, enemyPick);

        }//end ctor
        public string ChooseOption(string input, ref Fighter f, int enemyPick)
        {
            try
            {
                switch (input)
                {
                    ...
                    case "f":
                        EnemyGladiator enemy1 = new EnemyGladiator(enemyPick, ref f);
            ...
            catch (FormatException)
            {
                ...
                ArenaMenu arenaMenu = new ArenaMenu(ref f, enemyPick);
            }//end catch
            return input;
